...
Copyright 2013, 2014, 2015, 2016 Ciprian Popescu (email: getbutterfly@gmail.com)
...
add_action('admin_enqueue_scripts', 'p2v_admin_enqueue');
function p2v_admin_enqueue() {
